 ...
 * @date 2019-11-19
 */
#include "hybrid_astar_planner/smoother.h"
...
//                                SMOOTHING ALGORITHM
//###################################################
  void Smoother::smoothPath(DynamicVoronoi& voronoi,std::vector<Node3D> &smoothed_path) {
  ...
  pathLength = smoothed_path.size();
  std::vector<Node3D> newPath = smoothed_path;
