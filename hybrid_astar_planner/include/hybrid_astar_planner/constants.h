...
static const double width = 0.75 + 2 * bloating;//车的宽度
/// [m] --- The length of the vehicle
static const double length = 1 + 2 * bloating;//车的长度
/// [m] --- The minimum turning radius of the vehicle
static const float r = 1.6;//默认6 最小转弯半径
...
static const float penaltyTurning = 1.05;//原来是1.05
/// [#] --- A movement cost penalty for reversing (choosing motion primitives > 2)
static const float penaltyReversing = 1.5;//原来是2.0
/// [#] --- A movement cost penalty for change of direction (changing from primitives < 3 to primitives > 2)
static const float penaltyCOD = 1.5;//原来是2.0
...
//当前车的最小行驶宽度
static const float minRoadWidth = 1; //默认2
